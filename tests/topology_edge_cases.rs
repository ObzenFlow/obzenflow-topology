...
fn test_empty_topology() {
    ...
    // Use build_unchecked since we're testing structural behavior
    // Full validation would reject empty topology (no sources/sinks)
...
fn test_minimum_valid_pipeline() {
    ...
    // Use build_unchecked since we're testing structural traversal
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_diamond_topology() {
    ...
    // Use build_unchecked since we're testing structural diamond shape
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_self_loop_forbidden() {
    ...
    // Use build_unchecked since we're testing structural self-loop rejection
    match builder.build_unchecked() {
...
fn test_multiple_sources_and_sinks() {
    ...
    // Use build_unchecked since we're testing structural multiple pipelines
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_stage_name_retrieval() {
    ...
    // Use build_unchecked since we're testing stage name retrieval
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_flow_naming() {
    ...
    // Use build_unchecked since we're testing flow naming
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_has_edge_queries() {
    ...
    // Use build_unchecked since we're testing edge queries
    match builder.build_unchecked() {
        Ok(topology) => {
