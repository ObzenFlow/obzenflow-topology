...
fn test_valid_topology_creation() {
    ...
    // Use build_unchecked since we're testing structural topology creation
...
fn test_cycles_allowed() {
    ...
    // Use build_unchecked since we're testing structural cycle allowance
    match builder.build_unchecked() {
        Ok(topology) => {
...
fn test_duplicate_edge_detection() {
    ...
    // Use build_unchecked since we're testing structural duplicate detection
    match builder.build_unchecked() {
...
fn test_disconnected_stages_detection() {
    ...
    // Use build_unchecked since we're testing structural disconnected detection
    match builder.build_unchecked() {
...
fn test_complex_topology_metrics() {
    ...
    // Use build_unchecked since we're testing structural metrics
    match builder.build_unchecked() {
        Ok(topology) => {
            let metrics = topology.metrics();
...
fn test_isolated_node_detection() {
    ...
    // Use build_unchecked since we're testing structural isolated node detection
    match builder.build_unchecked() {
        Err(TopologyError::DisconnectedStages { stages }) => {
            assert_eq!(stages.len(), 1);
        }
